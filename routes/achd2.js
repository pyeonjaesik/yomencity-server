  ...
  if(database){
    database.AlModel.find({_id:_id},function(err,results){
      ...
      if(results.length>0){
        ...
        al.splice(afi,1,{type:'2',id:al[afi].id,name:al[afi].name,post_id:post_id,cn:al[afi].cn,ct:al[afi].ct,d:0});
